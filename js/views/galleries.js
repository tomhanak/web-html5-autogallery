...
define([
	...
	'text!templates/galleries.html',
], function($, _, Backbone, GalleriesCollection, galleriesTemplate) {
	var GalleriesView = Backbone.View.extend({
		template: _.template(galleriesTemplate),
		initialize: function(options) {
			this.options = options;
			this.collection = new GalleriesCollection();
		...
		render: function() {
			...
			this.$el.html(this.template({ galleriesPath: galleriesPath, galleries: this.collection.toJSON() }));
